...
import ArticleHeading from '../../components/Article/ArticleHeading.astro';
import ArticleExternalLink from '../../components/Article/ArticleExternalLink.astro';
...
- **SameSite** - it accepts three values - Strict, Lax (default in most browsers) and None.
  ...
  If you want to know more here is a <ArticleExternalLink href="https://web.dev/samesite-cookies-explained/" title="great article" /> which should explain everything.
...
- In 2020 default value of _SameSite_ attribute was set to _Lax_. Previously it was set to _None_.
  ...
  If you are interested in this topic, this <ArticleExternalLink href="https://www.thinktecture.com/en/identity/samesite/samesite-in-a-nutshell/#the-chrome-vs-safari-issue" title="article" /> is very thorough.
...
- Safari and their ITP (Intelligent Tracking Prevention) might remove cookie after just 1 day,
  ...
  More about that you can read in this <ArticleExternalLink href="https://www.convert.com/blog/privacy/itp-2-2-impact-abtesting-users/" title="article" />.
- Firefox with <ArticleExternalLink href="https://blog.mozilla.org/blog/2019/06/04/firefox-now-available-with-enhanced-tracking-protection-by-default/" title="Enhanced Tracking Protection" /> might also block various cookies,
  but mostly third-party tracking ones as default.

### Max cookie size

Cookies are restricted in their size and quantity.
Most browsers allow for 50 cookies per domain, 4096 bytes per cookie, 3000 cookies in total based on <ArticleExternalLink href="https://datatracker.ietf.org/doc/rfc6265/?include_text=1" title="RFC 6265" />.
...
So, developers have to include some libraries like <ArticleExternalLink href="https://www.npmjs.com/package/js-cookie" title="js-cookie" /> or write their own helper for that in **every** project.

But there is a light in a tunnel - <ArticleExternalLink href="https://wicg.github.io/cookie-store/" title="Cookie Store API" /> created by Google and implemented since Chrome 87.
...
<ArticleSummary createdAt={frontmatter.createdAt} updatedAt={frontmatter.updatedAt} />
